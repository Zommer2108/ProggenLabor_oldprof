...
class TestStatistikAusnahmen {
    ...
    int[] headlineNumbers = new int[blatt11.TestStatistikAusnahmen.MAX_LEVEL];
    ...
    void printHeadline(int level, String text) {
        ...
        for (int i = level; i < blatt11.TestStatistikAusnahmen.MAX_LEVEL; i++) {
            headlineNumbers[i] = 0;
        }
    ...
    void testDateiAusgabe() {
        ...
        blatt11.Statistik statistik = new blatt11.Statistik("Blöder\\Name//so");
    ...
    void testLeereStatistiken() {
        ...
        for (String test : tests) {
            ...
            try {
                blatt11.Statistik statistik = new blatt11.Statistik("Teststatistik_2");
                switch (++numTest) {
                    case 1:
    ...
    void testNames() {
        ...
        for (String[] test : tests) {
            ...
            try {
                ...
                blatt11.Statistik statistik = new blatt11.Statistik(test[0]);
    ...
    public static void main(String[] args) {
        blatt11.TestStatistikAusnahmen tests = new blatt11.TestStatistikAusnahmen();
