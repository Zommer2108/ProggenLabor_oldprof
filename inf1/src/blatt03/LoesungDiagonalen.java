...
public class LoesungDiagonalen extends JFrame {
    ...
    public void meineDiagonalen(Graphics g) {
        ...
        g.drawLine(x75, y25, x25, y25); //Gerade von oben rechts nach oben links
        g.drawLine(x25, y25, x25, y75); //Gerade von oben links nach unten links
        g.drawLine(x25, y75, x75, y75); //Gerade von unten links nach unten rechts
        g.drawLine(x75, y75, x75, y25); //Gerade von unten rechts nach oben rechts

        g.setColor(Color.RED);
        g.drawLine(x25, y25, x75, y75); //Diagonale von links oben nach rechts unten

        g.setColor(Color.BLUE);
        g.drawLine(x75, y25, x25, y75); //Diagonale von rechts oben nach links unten
    }
}
