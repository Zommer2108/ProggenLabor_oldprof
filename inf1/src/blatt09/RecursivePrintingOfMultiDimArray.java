...
public class RecursivePrintingOfMultiDimArray {
    static String[][][] eBau = {{ // UG
        { // Süd
            "EU01", "EU02", "EU03", "EU04",}, { // Mitte
        "WC", "Putzraum", "Dusche",}, { // Nord
        "EU11", "EU12", "EU13", "EU14",}}, { // EG
        { // Süd
            "E001", "E002", "E003", "E004",}, { // Nord
        "E011", "E012", "E014",}}};
    ...
    static void printInXml(Object[] objs, String indent) {
        for (Object obj : objs) {
            if (obj.getClass().isArray()) {
                ...
                System.out.print(indent + "<string>");
                System.out.print(obj.toString().trim());
